...
![Untitled](MVCC%20case%20study/Untitled.png)
...
![Untitled](MVCC%20case%20study/Untitled%201.png)
...
- postgresql: read commited **(x=50, y=80)**
    ...
    ![Untitled](MVCC%20case%20study/Untitled%202.png)
...
- postgresql: read repeatable **(x=10, y=50)**
    ...
    ![Untitled](MVCC%20case%20study/Untitled%203.png)
...
- mysql: repeatable read **(x=10, y=50)**
    ...
    ![Untitled](MVCC%20case%20study/Untitled%204.png)
...
- mysql: repeatable read + locking read (x=40, y=50)
    ...
    ![Untitled](MVCC%20case%20study/Untitled%205.png)
...
- postgresql&mysql: repeatable read **(x=20, y=20) write skew**
    ...
    ![Untitled](MVCC%20case%20study/Untitled%206.png)
...
- mysql: repeatable read **(x=20, y=30)** 해결
    ...
    ![Untitled](MVCC%20case%20study/Untitled%207.png)
...
- postgresql: repeatable read **(x=20, y=10)** 해결
    ...
    ![Untitled](MVCC%20case%20study/Untitled%208.png)
